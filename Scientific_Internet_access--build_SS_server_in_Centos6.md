...
### Buy the VPS
1. notice: is vps(Virtual Private Server), not other!
...
2. make sure the ip address can connect.
    + ping it
3. ***choose Centos 6 x86 bbr !!!***
    + bbr is a the Google Inc. optimization of acceleration

### SSH connect vps
1. make sure you username and password
...
### Install SS-Python
1. `yum install wget`(maybe option)
2. `cd /path/to/you/want`(option)
3. command
```sh
...
```
4. password(ss-server)-->port(1-65535)-->cipher
5. can ss-Python, ss-R, etc. have scripts.


### appendix
1. [shadowsocks.sh](https://raw.githubusercontent.com/teddysun/shadowsocks_install/master/shadowsocks.sh)
    + [teddysun/shadowsocks_instal](https://github.com/teddysun/shadowsocks_install/tree/master)
